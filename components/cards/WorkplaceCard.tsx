...
export default function WorkplaceCard({ workplace, onClick }: WorkplaceCardProps) {
  ...
  return (
    <div
      onClick={onClick}
      className="group relative bg-background-card rounded-2xl overflow-hidden border-2 border-border-gold/30 hover:border-primary-gold transition-all duration-300 cursor-pointer hover:shadow-xl hover:shadow-primary-gold/20 hover:-translate-y-1 h-full min-h-[420px] flex flex-col"
    >
      {/* Image/Banner */}
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        {/* Location */}
        <div className="flex items-center gap-2 mb-3 text-text-secondary text-sm min-h-[24px]">
        ...
        {/* Barbers count */}
        <div className="text-sm text-text-secondary mb-4 min-h-[20px]">
        ...
        {/* Social Media Icons */}
        <div className="flex items-center gap-3 mt-auto pt-4 border-t border-border-gold/20 min-h-[40px]">
