...
export default function BarberCard({ barber, onClick }: BarberCardProps) {
  ...
  return (
    <div
      onClick={onClick}
      className="group relative bg-background-card rounded-2xl p-6 border-2 border-border-gold/30 hover:border-primary-gold transition-all duration-300 cursor-pointer hover:shadow-xl hover:shadow-primary-gold/20 hover:-translate-y-1 h-full min-h-[380px] flex flex-col"
    >
      {/* Avatar/Image */}
      ...
      {/* Social Media Icons */}
      <div className="flex items-center justify-center gap-3 mt-auto pt-4 border-t border-border-gold/20 min-h-[40px]">
